...
class Thread extends Model
{
    ...
    public function getThreadSubject(array $params): array
    {
        $pdo = $this->newDbCon();
    ...
    public function createThread(String $subject, String $text, String $categoryId): string
    {
        $pdo = $this->newDbCon();
    ...
    public function getThreads(String $userID): array
    {
        $pdo = $this->newDbCon();
